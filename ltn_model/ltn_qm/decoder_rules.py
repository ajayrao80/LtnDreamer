...
class DecoderRules:
    ...
    def DecoderA0(self, init_image_a_0):
    ...
    def DecoderA1(self, init_image_a_1):
    ...
    def DecoderA2(self, init_image_a_2):
    ...
    def DecoderA3(self, init_image_a_3):  
    ...
    def DecoderA4(self, init_image_a_4):
    ...
    def DecoderA5(self, init_image_a_5):
    ...
    def get_reconstruction_based_on_actions(self, init_image, actions):
        ...
        if init_image_a_0.shape[0] != 0:
            reconstructions[actions == 0] = self.DecoderA0(init_image_a_0)
        if init_image_a_1.shape[0] != 0:
            reconstructions[actions == 1] = self.DecoderA1(init_image_a_1)
        if init_image_a_2.shape[0] != 0:
            reconstructions[actions == 2] = self.DecoderA2(init_image_a_2)
        if init_image_a_3.shape[0] != 0:
            reconstructions[actions == 3] = self.DecoderA3(init_image_a_3)
        if init_image_a_4.shape[0] != 0:
            reconstructions[actions == 4] = self.DecoderA4(init_image_a_4)
        if init_image_a_5.shape[0] != 0:
            reconstructions[actions == 5] = self.DecoderA5(init_image_a_5)
