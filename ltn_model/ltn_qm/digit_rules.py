...
class DigitRules:
    ...
    def get_digit_rules(self, init_image, next_image, digit_labels_f_init, digit_labels_r_init, digit_labels_u_init, digit_labels_f_next, digit_labels_r_next, digit_labels_u_next):
        ...
        digit_rules_f_init = Forall([init_image, digit_labels_f_init], self.ltn_F_and_P.DigitP(self.ltn_F_and_P.Front(init_image), digit_labels_f_init))
        ltn.diag(init_image, digit_labels_f_init)
        ...
        ltn.diag(init_image, digit_labels_r_init)
        digit_rules_r_init_rp = Forall([init_image, digit_labels_r_init], self.ltn_F_and_P.DigitP(self.ltn_F_and_P.RotPlus(self.ltn_F_and_P.Right(init_image)), digit_labels_r_init))
        ltn.diag(init_image, digit_labels_r_init)
        digit_rules_r_init_rm = Forall([init_image, digit_labels_r_init], self.ltn_F_and_P.DigitP(self.ltn_F_and_P.RotMinus(self.ltn_F_and_P.Right(init_image)), digit_labels_r_init))
        ltn.diag(init_image, digit_labels_u_init)
        digit_rules_u_init = Forall([init_image, digit_labels_u_init], self.ltn_F_and_P.DigitP(self.ltn_F_and_P.Up(init_image), digit_labels_u_init))
        ltn.diag(init_image, digit_labels_u_init)
        digit_rules_u_init_rp = Forall([init_image, digit_labels_u_init], self.ltn_F_and_P.DigitP(self.ltn_F_and_P.RotPlus(self.ltn_F_and_P.Up(init_image)), digit_labels_u_init))
        ltn.diag(init_image, digit_labels_u_init)
        digit_rules_u_init_rm = Forall([init_image, digit_labels_u_init], self.ltn_F_and_P.DigitP(self.ltn_F_and_P.RotMinus(self.ltn_F_and_P.Up(init_image)), digit_labels_u_init))

        ltn.diag(next_image, digit_labels_f_next)
        digit_rules_f_next = Forall([next_image, digit_labels_f_next], self.ltn_F_and_P.DigitP(self.ltn_F_and_P.Front(next_image), digit_labels_f_next))
        ltn.diag(next_image, digit_labels_f_next)
        digit_rules_f_next_rp = Forall([next_image, digit_labels_f_next], self.ltn_F_and_P.DigitP(self.ltn_F_and_P.RotPlus(self.ltn_F_and_P.Front(next_image)), digit_labels_f_next))
        ltn.diag(next_image, digit_labels_f_next)
        digit_rules_f_next_rm = Forall([next_image, digit_labels_f_next], self.ltn_F_and_P.DigitP(self.ltn_F_and_P.RotMinus(self.ltn_F_and_P.Front(next_image)), digit_labels_f_next))
        ltn.diag(next_image, digit_labels_r_next)
        digit_rules_r_next = Forall([next_image, digit_labels_r_next], self.ltn_F_and_P.DigitP(self.ltn_F_and_P.Right(next_image), digit_labels_r_next))
        ltn.diag(next_image, digit_labels_r_next)
        digit_rules_r_next_rp = Forall([next_image, digit_labels_r_next], self.ltn_F_and_P.DigitP(self.ltn_F_and_P.RotPlus(self.ltn_F_and_P.Right(next_image)), digit_labels_r_next))
        ltn.diag(next_image, digit_labels_r_next)
        digit_rules_r_next_rm = Forall([next_image, digit_labels_r_next], self.ltn_F_and_P.DigitP(self.ltn_F_and_P.RotMinus(self.ltn_F_and_P.Right(next_image)), digit_labels_r_next))
        ltn.diag(next_image, digit_labels_u_next)
        digit_rules_u_next = Forall([next_image, digit_labels_u_next], self.ltn_F_and_P.DigitP(self.ltn_F_and_P.Up(next_image), digit_labels_u_next))
        ltn.diag(next_image, digit_labels_u_next)
        digit_rules_u_next_rp = Forall([next_image, digit_labels_u_next], self.ltn_F_and_P.DigitP(self.ltn_F_and_P.RotPlus(self.ltn_F_and_P.Up(next_image)), digit_labels_u_next))
        ltn.diag(next_image, digit_labels_u_next)
