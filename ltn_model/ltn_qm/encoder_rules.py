...
class EncoderRules:
    ...
    def EncoderRuleA0(self, init_image, next_image, action, p=3):
    ...
    def EncoderRuleA2(self, init_image, next_image, action, p=3):
        ltn.diag(init_image, next_image, action)
        return Forall([init_image, next_image, action],
    ...
    def EncoderEqRuleA0(self, init_image, r, u, action, p=3):
    ...
    def EncoderEqRuleA1(self, init_image, f, r, action, p=3):
    ...
    def EncoderEqRuleA2(self, init_image, f, u, action, p=3):
    ...
    def EncoderEqRuleA5(self, init_image, f, r, action, p=3):
        ltn.diag(init_image, f, r, action)
        return Forall([init_image, f, r, action],
            And(Eq(self.ltn_F_and_P.RotChange(self.ltn_F_and_P.Front(init_image), action), f), Eq(self.ltn_F_and_P.RotChange(self.ltn_F_and_P.Up(init_image), action), r)), p=p
        )
