...
from ltn_model.modules.orientation import RotChange
...
class LTNModel:
    def __init__(self, front_=None, right_=None, up_=None, dec_=None, rot_plus_=None, rot_minus_=None, digits_=None, rot_change_=None):
        ...
        self.rot_change = RotChange().to(self.device) if rot_change_ is None else rot_change_
    ...
    def get_params(self):
        ...
        #)
        params = list(self.front.parameters()) + list(self.right.parameters()) + list(self.up.parameters()) + list(self.dec.parameters()) + list(self.rot_change.parameters())  # + list(self.rot_plus.parameters()) + list(self.rot_minus.parameters()) #+ list(self.digits.parameters())
        return params
    ...
    def save_all_models(self, save_path):
        ...
        save_model(self.rot_change, save_path, "rot_change")
    ...
    def load_all_models(self, model_path, front, right, up, dec, rot_change) #, rot_plus, rot_minus, digits=None):
        ...
        self.rot_change = self.load_model(f"{model_path}/{rot_change}", self.rot_change)
