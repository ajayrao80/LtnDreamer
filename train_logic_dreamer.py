from dreamer.main_shared_models import main
import argparse
import random
...
def train_ltn_world_model(lr, epochs, login_key, model_save_path, train_dataset_path, test_dataset_path, free_nats, logic_weight, stoch_dim, deter_dim, beta=1.0, logic_models_path=None, project_name=None, train_dataset_size=10, test_dataset_size=10, episode_len=5, batch_size=32):
    lr = lr
    epochs = epochs
    ...
    logic_models_path = logic_models_path
    ...
    main(lr, epochs, embed_dim, stoch_dim, deter_dim, train_dataset_path, test_dataset_path, beta, login_key, model_save_path, logic_models_path=logic_models_path, free_nats=free_nats, project_name=project_name, logic_weight=logic_weight, logic_decay_rate=1.0, train_all=train_all, batch_size=batch_size, T=episode_len)     
...
if __name__ == "__main__":
    ...
    parser.add_argument('--logic_models_path', type=str, default=None)
    ...
    parser.add_argument('--logic_weight', type=float, default=25000.0)
